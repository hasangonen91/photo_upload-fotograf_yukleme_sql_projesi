package com.hasan.yemektariflerisqlite
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if(gelenBilgi.equals("menudengeldim")){
                //yeni bir yemek ekelmeye geldi
                yemekIsmiText.setText("")
                yemekMalzemeText.setText("")
                button.visibility= View.VISIBLE
                val gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources,R.drawable.ic_baseline_camera_alt_24)
                ...
                context?.let {
                    ...
                    try {
                        ...
                        while (cursor.moveToNext()){
                            yemekIsmiText.setText(cursor.getString(yemekMalzemeleriIndex))
